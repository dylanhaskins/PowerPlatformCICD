...
namespace Entities {
    ...
    public partial class Contact : ExtendedEntity<ContactState, Contact_StatusCode> {
        ...
        /// <para>Display Name: Address 1: Line 1</para>
        /// </summary>
        ...
        /// <para>Display Name: Address 1: Line 2</para>
        /// </summary>
        ...
        /// <para>Display Name: Address 1: Line 3</para>
        /// </summary>
        ...
        /// <para>Display Name: Address 2: Line 1</para>
        /// </summary>
        ...
        /// <para>Display Name: Address 2: Line 2</para>
        /// </summary>
        ...
        /// <para>Display Name: Address: Line 3</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Enter the person's birthday for use in customer gift programs or other communications.</para>
        ...
        /// <summary>
        /// <para>Select whether the person allows direct email sent from Microsoft Dynamics 365. If Do Not Allow is selected, Microsoft Dynamics 365 will not send the email.</para>
        ...
        /// <summary>
        /// <para>Select whether the person accepts phone calls. If Do Not Allow is selected, the person will be excluded from any phone call activities distributed in marketing campaigns.</para>
        ...
        /// <summary>
        /// <para>Select whether the person allows direct mail. If Do Not Allow is selected, the person will be excluded from letter activities distributed in marketing campaigns.</para>
        ...
        /// <summary>
        /// <para>Type the primary email address for the person.</para>
        ...
        /// <summary>
        /// <para>Type the person's first name to make sure the person is addressed correctly in sales calls, email, and marketing campaigns.</para>
        ...
        /// <summary>
        /// <para>Combines and shows the person's first and last names so that the full name can be displayed in views and reports.</para>
        ...
        /// <summary>
        /// <para>Type the person's last name to make sure the person is addressed correctly in sales calls, email, and marketing campaigns.</para>
        ...
        /// <summary>
        /// <para>Type the person's middle name or initial to make sure the person is addressed correctly.</para>
        /// <para>Display Name: Middle name(s)</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Type the mobile phone number for the person.</para>
        ...
        /// <summary>
        /// <para>Select the parent organisation or parent person for the person to provide a quick link to additional details, such as financial information, activities, and opportunities.</para>
        ...
        /// <para>Display Name: Preferred contact time</para>
        /// </summary>
        ...
        /// <para>Display Name: Preferred contact method</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Shows whether the person is active or inactive. Inactive persons are read-only and can't be edited unless they are reactivated.</para>
        ...
        /// <summary>
        /// <para>Select the person's status.</para>
        ...
        /// <summary>
        /// <para>Type the suffix used in the person's name, such as Jr. or Sr. to make sure the person is addressed correctly in sales calls, email, and marketing campaigns.</para>
        ...
        /// <summary>
        /// <para>Type the main phone number for this person.</para>
        ...
        /// <summary>
        /// <para>Type a second phone number for this person.</para>
        ...
        /// <summary>
        /// <para>Display Name: COS person reference number</para>
        /// </summary>
        [AttributeLogicalName("dia_cosreferencenumber")]
        public string dia_cosreferencenumber {
            get {
                return GetAttributeValue<string>("dia_cosreferencenumber");
            }
            set {
                SetAttributeValue("dia_cosreferencenumber", value);
            }
        }
        ...
        /// </summary>
        [AttributeLogicalName("dia_countryofbirthid")]
        public EntityReference dia_countryofbirthid {
            get {
                return GetAttributeValue<EntityReference>("dia_countryofbirthid");
            }
            set {
                SetAttributeValue("dia_countryofbirthid", value);
            }
        }
        
        /// <summary>
        /// <para>Display Name: Date of death</para>
        /// </summary>
        [AttributeLogicalName("dia_dateofdeath")]
        public DateTime? dia_dateofdeath {
            get {
                return GetAttributeValue<DateTime?>("dia_dateofdeath");
            }
            set {
                SetAttributeValue("dia_dateofdeath", value);
            }
        }
        
        /// <summary>
        /// <para>Display Name: Date POI set</para>
        /// </summary>
        [AttributeLogicalName("dia_datepoiset")]
        public DateTime? dia_datepoiset {
            get {
                return GetAttributeValue<DateTime?>("dia_datepoiset");
            }
            set {
                SetAttributeValue("dia_datepoiset", value);
            }
        }
        
        /// <summary>
        /// <para>Display Name: Do not allow SMS</para>
        /// </summary>
        [AttributeLogicalName("dia_donotallowsms")]
        public bool? dia_donotallowsms {
            get {
                return GetAttributeValue<bool?>("dia_donotallowsms");
            }
            set {
                SetAttributeValue("dia_donotallowsms", value);
            }
        }
        ...
        /// <summary>
        /// <para>Display Name: Person of interest</para>
        /// </summary>
        [AttributeLogicalName("dia_personofinterest")]
        public dia_yesno? dia_personofinterest {
            get {
                return GetOptionSetValue<dia_yesno>("dia_personofinterest");
            }
            set {
                SetOptionSetValue("dia_personofinterest", value);
            }
        }
        ...
        /// </summary>
        [AttributeLogicalName("dia_placeofbirth")]
        public string dia_placeofbirth {
            get {
                return GetAttributeValue<string>("dia_placeofbirth");
            }
            set {
                SetAttributeValue("dia_placeofbirth", value);
            }
        }
        ...
        /// </summary>
        [AttributeLogicalName("dia_preferrednames")]
        public string dia_preferrednames {
            get {
                return GetAttributeValue<string>("dia_preferrednames");
            }
            set {
                SetAttributeValue("dia_preferrednames", value);
            }
        }
        ...
        public IEnumerable<dia_cbgapplication> dia_contact_cbgapplication_subjectpersonid {
            get {
                return GetRelatedEntities<dia_cbgapplication>("dia_contact_cbgapplication_subjectpersonid", null);
            }
            set {
                SetRelatedEntities("dia_contact_cbgapplication_subjectpersonid", null, value);
            }
        }
        
        [RelationshipSchemaName("dia_contact_livenesscheck")]
        public IEnumerable<dia_livenesscheck> dia_contact_livenesscheck {
            get {
                return GetRelatedEntities<dia_livenesscheck>("dia_contact_livenesscheck", null);
            }
            set {
                SetRelatedEntities("dia_contact_livenesscheck", null, value);
            }
        }
        
        [RelationshipSchemaName("dia_contact_name_personid")]
        public IEnumerable<dia_name> dia_contact_name_personid {
            get {
                return GetRelatedEntities<dia_name>("dia_contact_name_personid", null);
            }
            set {
                SetRelatedEntities("dia_contact_name_personid", null, value);
            }
        }
        
        [AttributeLogicalName("dia_countryofbirthid")]
        [RelationshipSchemaName("dia_country_contact_countryofbirthid")]
        public dia_country dia_country_contact_countryofbirthid {
            get {
                return GetRelatedEntity<dia_country>("dia_country_contact_countryofbirthid", null);
            }
            set {
                SetRelatedEntity("dia_country_contact_countryofbirthid", null, value);
            }
        }
        
        [AttributeLogicalName("dia_genderid")]
        [RelationshipSchemaName("dia_gender_contact_genderid")]
        public dia_gender dia_gender_contact_genderid {
            get {
                return GetRelatedEntity<dia_gender>("dia_gender_contact_genderid", null);
            }
            set {
                SetRelatedEntity("dia_gender_contact_genderid", null, value);
            }
        }
        
        [RelationshipSchemaName("diap_contact_dia_cbgapplication_portaluser")]
        public IEnumerable<dia_cbgapplication> diap_contact_dia_cbgapplication_portaluser {
            get {
                return GetRelatedEntities<dia_cbgapplication>("diap_contact_dia_cbgapplication_portaluser", null);
            }
            set {
                SetRelatedEntities("diap_contact_dia_cbgapplication_portaluser", null, value);
            }
        }
        ...
        public IEnumerable<Incident> msa_contact_incident {
            ...
            set {
                SetRelatedEntities("msa_contact_incident", null, value);
            }
        }
        ...
        /// <summary>
        /// <para>Retrieves the record using the alternate key called 'COS reference number'</para>
        /// </summary>
        public static Contact Retrieve_dia_cosreferencenumber(IOrganizationService service, string dia_cosreferencenumber, params Expression<Func<Contact,object>>[] attrs) {
            KeyAttributeCollection keys = new KeyAttributeCollection();
            keys.Add("dia_cosreferencenumber", dia_cosreferencenumber);
            return Retrieve_AltKey(service, keys, attrs);
        }
        
        /// <summary>
        /// <para>Set values for the alternate key called 'COS reference number'</para>
        /// </summary>
        public void AltKey_dia_cosreferencenumber(string dia_cosreferencenumber) {
            KeyAttributes.Clear();
            KeyAttributes.Add("dia_cosreferencenumber", dia_cosreferencenumber);
        }
    }
