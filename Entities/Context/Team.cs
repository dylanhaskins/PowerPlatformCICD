...
namespace Entities {
    ...
    public partial class Team : ExtendedEntity<EmptyEnum, EmptyEnum> {
        ...
        public IEnumerable<devops_EntityA> team_devops_entitya {
            get {
                return GetRelatedEntities<devops_EntityA>("team_devops_entitya", null);
            }
            set {
                SetRelatedEntities("team_devops_entitya", null, value);
            }
        }
        
        [RelationshipSchemaName("team_devops_entityb")]
        public IEnumerable<devops_EntityB> team_devops_entityb {
            get {
                return GetRelatedEntities<devops_EntityB>("team_devops_entityb", null);
            }
            set {
                SetRelatedEntities("team_devops_entityb", null, value);
            }
        }
