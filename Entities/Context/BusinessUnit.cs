...
namespace Entities {
    ...
    public partial class BusinessUnit : ExtendedEntity<EmptyEnum, EmptyEnum> {
        ...
        public IEnumerable<devops_EntityA> business_unit_devops_entitya {
            get {
                return GetRelatedEntities<devops_EntityA>("business_unit_devops_entitya", null);
            }
            set {
                SetRelatedEntities("business_unit_devops_entitya", null, value);
            }
        }
        
        [RelationshipSchemaName("business_unit_devops_entityb")]
        public IEnumerable<devops_EntityB> business_unit_devops_entityb {
            get {
                return GetRelatedEntities<devops_EntityB>("business_unit_devops_entityb", null);
            }
            set {
                SetRelatedEntities("business_unit_devops_entityb", null, value);
            }
        }
