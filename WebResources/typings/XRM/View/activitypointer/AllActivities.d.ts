declare namespace Views.activitypointer {
  interface AllActivities {
    ...
    senton: string;
    senton_Value: Date;
    activitypointerowningusersystemusersystemuserid_internalemailaddress: string;
    activitypointerowningusersystemusersystemuserid_internalemailaddress_Value: string;
