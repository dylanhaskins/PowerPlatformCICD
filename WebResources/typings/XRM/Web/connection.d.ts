declare namespace Web {
  ...
  interface Connection_RelatedOne {
    ...
    record1id_activitypointer: WebMappingRetrieve<Web.ActivityPointer_Select,Web.ActivityPointer_Expand,Web.ActivityPointer_Filter,Web.ActivityPointer_Fixed,Web.ActivityPointer_Result,Web.ActivityPointer_FormattedResult>;
    ...
    record1id_email: WebMappingRetrieve<Web.Email_Select,Web.Email_Expand,Web.Email_Filter,Web.Email_Fixed,Web.Email_Result,Web.Email_FormattedResult>;
    ...
    record2id_activitypointer: WebMappingRetrieve<Web.ActivityPointer_Select,Web.ActivityPointer_Expand,Web.ActivityPointer_Filter,Web.ActivityPointer_Fixed,Web.ActivityPointer_Result,Web.ActivityPointer_FormattedResult>;
    ...
    record2id_email: WebMappingRetrieve<Web.Email_Select,Web.Email_Expand,Web.Email_Filter,Web.Email_Fixed,Web.Email_Result,Web.Email_FormattedResult>;
